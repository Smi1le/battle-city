#ifndef LEVEL_H
#define LEVEL_H
//#pragma comment(lib, "C:\\Users\\asus1\\Documents\\Visual Studio 2015\\Projects\\SFML5\\SFML5\\d3d10.lib") 
//#pragma comment(lib, "C:\\Users\\asus1\\Documents\\Visual Studio 2015\\Projects\\SFML5\\SFML5\\d3dx10.lib") 
...
bool Level::LoadFromFile(std::string filename)//двоеточия-обращение к методам класса вне класса 
{
	...
	TiXmlElement *tilesetElement = nullptr;
	tilesetElement = map->FirstChildElement("tileset");
	firstTileID = atoi(tilesetElement->Attribute("firstgid"));

	// source - путь до картинки в контейнере image
	TiXmlElement *image = nullptr;
	...
	// работа со слоями
	TiXmlElement *layerElement = nullptr;
	...
	while (layerElement)
	{
		...
		TiXmlElement *tileElement = nullptr;
	...
	// работа с объектами
	TiXmlElement *objectGroupElement = nullptr;
	...
	if (map->FirstChildElement("objectgroup") != NULL)
	{
		...
		while (objectGroupElement)
		{
			...
			while (objectElement)
			{
				...
				// "переменные" объекта
				TiXmlElement *properties = nullptr;
